...
public class CoinGui {
    ...
    public static void openCoinsGui(Player player){
        ...
        Gui gui = Gui.gui()
                .title(Component.text("§6§lCOINS §8(INDSÆT)"))
        ...
        gui.setItem(0, ItemBuilder.from(add).name(Component.text("§a+100")).setLore("§fTryk for at tilføje:", "§8» §a100 Coins").asGuiItem(event -> {
            ...
            gui.setItem(2, ItemBuilder.from(Material.EMPTY_MAP).name(Component.text("§6§nInformation:")).setLore("§fAntal coins valgt:", "§8» §e" + coins.get()).asGuiItem(e -> {
                ...
                Bukkit.getOnlinePlayers().stream().forEach(p-> {
                    if (p.isOp()){
                        ...
                        p.sendMessage(" §e" + e.getWhoClicked().getName() + "§f ønsker at købe §e" + coins.get() + "§f coins");
                        p.sendMessage(" §a");
                    }
                });
                e.getWhoClicked().sendMessage(" §a");
                e.getWhoClicked().sendMessage("§8[§6§lCOIN §f§lSYSTEM§8]");
                e.getWhoClicked().sendMessage(" §eDu§f har anmodet om at købe §e" + coins.get() + "§f coins§");
                e.getWhoClicked().sendMessage(" §a");
            }));
            gui.update();
        }));
        ...
        gui.setItem(2, ItemBuilder.from(Material.EMPTY_MAP).name(Component.text("§6§nInformation:")).setLore("§fAntal coins valgt:", "§8» §e" + coins.get()).asGuiItem(event -> {
